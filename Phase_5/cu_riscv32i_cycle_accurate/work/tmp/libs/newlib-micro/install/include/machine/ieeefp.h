...
// ========== CODASIP ==========
// Endianity as defined in Clang CodasipTargetInfo, but __IEEE_* defines must
// be here because of __OBSOLETE_MATH_DEFAULT definition.
// We could just move the definition of __OBSOLETE_MATH_DEFAULT there, but this
// would cause errors if anything more was added here in future versions.
#ifdef __codasip__
