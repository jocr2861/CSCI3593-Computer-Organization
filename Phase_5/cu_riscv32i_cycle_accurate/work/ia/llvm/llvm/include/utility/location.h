...
#ifndef UTILITY_LOCATION_H_
#define UTILITY_LOCATION_H_
...
public:
     ...
     */
    Location(const filesystem::Path& file = "", const int line = 0, const int column = 0);
    /**
     * \brief Getter
     */
    bool Empty() const;
...
{
    return l.GetFile() == r.GetFile() && l.GetLine() == r.GetLine() && l.GetColumn() == r.GetColumn();
}
