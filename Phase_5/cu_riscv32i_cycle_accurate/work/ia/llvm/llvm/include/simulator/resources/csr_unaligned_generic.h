...
#ifndef SIMULATOR_RESOURCES_UNALIGNED_H_
#define SIMULATOR_RESOURCES_UNALIGNED_H_
...
public:
    ...
    static T
    dread(const ContainerType& src, const codasip_address_t addr, const Index bi = 0, const Index bc = BPW);

    template<Endianness _Endianness, class ContainerType>
    static T
    read(const ContainerType& src, const codasip_address_t addr, const Index bi = 0, const Index bc = BPW);
    ...
    /// Common unaligned interface (params via Payload)

    template<Endianness _Endianness, class ContainerType, class _Pt>
    static T dread(const ContainerType& src, const codasip_address_t addr, const Payload<_Pt>& p);

    template<Endianness _Endianness, class ContainerType, class _Pt>
    static T read(const ContainerType& src, const codasip_address_t addr, const Payload<_Pt>& p);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T, int _ByteBits, codasip_address_t _Size>
RES_INLINE codasip_address_t UnalignedGeneric<T, _ByteBits, _Size>::get_index(
    const codasip_address_t addr)
{
    return addr / BPW;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T, int _ByteBits, codasip_address_t _Size>
RES_INLINE codasip_address_t UnalignedGeneric<T, _ByteBits, _Size>::get_offset(
    const codasip_address_t addr)
{
    return addr % BPW;
}
...
template<class T, int _ByteBits, codasip_address_t _Size>
template<Endianness _Endianness>
RES_INLINE void UnalignedGeneric<T, _ByteBits, _Size>::write_shift(data_type& dst,
    data_type& mask,
    data_type src,
    const Index bi,
    const Index bc)
...
template<class T, int _ByteBits, codasip_address_t _Size>
template<Endianness _Endianness, class ContainerType>
RES_INLINE T UnalignedGeneric<T, _ByteBits, _Size>::dread(const ContainerType& src,
    const codasip_address_t addr,
    const Index bi,
    const Index bc)
{
...
template<class T, int _ByteBits, codasip_address_t _Size>
template<Endianness _Endianness, class ContainerType>
RES_INLINE void UnalignedGeneric<T, _ByteBits, _Size>::dwrite(ContainerType&& dst,
    param_type data,
    const codasip_address_t addr,
    const Index bi,
    const Index bc)
...
RES_INLINE void UnalignedGeneric<T, _ByteBits, _Size>::dwrite(ContainerType&& dst,
    ...
    const Payload<_Pt>& p)
{
    return dwrite<_Endianness>(dst, data, addr, p.get_bi(), p.get_bc());
}
...
RES_INLINE void UnalignedGeneric<T, _ByteBits, _Size>::write(ContainerType&& dst,
    ...
    const Payload<_Pt>& p)
{
    return write<_Endianness>(dst, data, addr, p.get_bi(), p.get_bc());
}

}   // namespace resources
}   // namespace codasip

#endif   // SIMULATOR_RESOURCES_UNALIGNED_H_
