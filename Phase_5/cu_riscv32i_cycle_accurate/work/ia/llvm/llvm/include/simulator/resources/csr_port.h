...
#ifndef SIMULATOR_RESOURCES_CSR_PORT_H_
#define SIMULATOR_RESOURCES_CSR_PORT_H_
 ...
 *  \param  name Name of PORT prefix (usually port name).
 */
#define CODASIP_PORT_CB_SELECT(name) CODASIP_PORT_CB_SELECT_FULL(name##_write_cb, name##_dwrite_cb)
 ...
 */
template<class T,
    typename M = detail::PortModule<typename T::data_type>,
    class S = detail::CODASIP_PORT_CB_SELECT_FULL(write_cb, dwrite_cb)>
...
public:
     ...
     * \copydoc VariableStorage::write
     */
    void write(param_type data) override;
    void dwrite(param_type data) override;
    /** \} */
...
private:
    void write_cb(param_type) override;
    void dwrite_cb(param_type) override;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T, typename M, class S>
RES_INLINE void Port<T, M, S>::write(param_type data)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T, typename M, class S>
RES_INLINE void Port<T, M, S>::dwrite(param_type data)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T, typename M, class S>
RES_INLINE void Port<T, M, S>::write_cb(param_type data)
{
    T::write(data);
    if (m_Module)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T, typename M, class S>
RES_INLINE void Port<T, M, S>::dwrite_cb(param_type data)
{
    T::dwrite(data);
    if (m_Module)
    {
...
#endif   // SIMULATOR_RESOURCES_CSR_PORT_H_
