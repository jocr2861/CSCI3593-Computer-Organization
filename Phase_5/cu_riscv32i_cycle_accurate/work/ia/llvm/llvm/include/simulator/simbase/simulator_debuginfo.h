...
#define DEBUGINFO_VISITABLE virtual void Accept(DebugInfoVisitor& visitor) const;
...
public:
    ...
    CODASIP_ENUM_CLASS_STR(Type, (EVENT, "EVENT"), (ELEMENT, "ELEMENT"), (FUNCTION, "FUNCTION"));

    /**
     *  \brief  Constructor
     *  \param  type        Type of function
     *  \param  name        Name of function or event
     *  \param  instanceId  Id of the event/element instance
     */
    Function(const Type type, const std::string& name, const std::string& instanceId);
