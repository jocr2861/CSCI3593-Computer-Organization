...
#ifndef COMMON_CODASIP_INTEGER_FIXED_ARRAY_INTEGER_BACKEND_H_
#define COMMON_CODASIP_INTEGER_FIXED_ARRAY_INTEGER_BACKEND_H_
...
template<unsigned _CODASIP_BITS,
    bool _CODASIP_SIGN,
    bool _CODASIP_IS_VALID = (_CODASIP_BITS != 0) && !(_CODASIP_BITS == 1 && _CODASIP_SIGN)>
class FixedArrayIntegerBackend;
...
private:
    ...
    typedef ::codasip::integer::detail::array_type_helper<_CODASIP_BITS, _CODASIP_SIGN, 32> array_helper;
...
public:
    ...
    template<typename T>
    _CODASIP_INT_ENABLE_IF_POD(T, reference)
    operator=(const T rhs) CODASIP_NOEXCEPT;
    /**
...
private:
    ...
    {   /// actual bit-width of the underlying POD type
        ...
        REMINDER_RIGHT = (BIT_WIDTH % UNDERLYING_BIT_WIDTH == 0) ? UNDERLYING_BIT_WIDTH
...
struct numeric_limits<::codasip::integer::backends::FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>>
  : public ::codasip::integer::detail::numeric_limits_base<
        ::codasip::integer::backends::FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>>
{};
...
#include "common/codasip_integer/fixed_array_backend/backend_impl.h"

#endif   // COMMON_CODASIP_INTEGER_FIXED_ARRAY_INTEGER_BACKEND_H_
