...
#ifndef COMMON_CODASIP_INTEGER_INTEGER_NUMBER_COMPARISON_H_
#define COMMON_CODASIP_INTEGER_INTEGER_NUMBER_COMPARISON_H_
...
_CODASIP_INT_INLINE _CODASIP_INT_ENABLE_IF(
    (IntegerNumber<LHS_BITS, LHS_SIGN>::IS_WRAPPER == IntegerNumber<RHS_BITS, RHS_SIGN>::IS_WRAPPER),
    bool)
operator==(const IntegerNumber<LHS_BITS, LHS_SIGN>& lhs, const IntegerNumber<RHS_BITS, RHS_SIGN>& rhs)
...
#endif   // COMMON_CODASIP_INTEGER_INTEGER_NUMBER_COMPARISON_H_
