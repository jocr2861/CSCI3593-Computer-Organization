...
#ifndef COMMON_CODASIP_INTEGER_NATIVE_INTEGER_BACKEND_H_
#define COMMON_CODASIP_INTEGER_NATIVE_INTEGER_BACKEND_H_
...
#    define _CODASIP_NATIVE_INT_BACKEND_DEF_UNARY(op, func)                               \
        template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>                              \
        _CODASIP_INT_INLINE                                                               \
            typename NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::value_type \
                NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator op()   \
                    const CODASIP_NOEXCEPT                                                \
        {                                                                                 \
...
#    define _CODASIP_NATIVE_INT_BACKEND_COMPARE_CND(rhsBits, rhsSign) \
        (::codasip::integer::detail::                                 \
                use_direct_native_int_comparator<_CODASIP_BITS, _CODASIP_SIGN, rhsBits, rhsSign>::value)
#else
...
public:
    ...
    typedef
        typename ::codasip::integer::detail::underlying_type_helper<BIT_WIDTH, IS_SIGNED>::type pod_type;
    /// select unsigned POD type
    typedef
        typename ::codasip::integer::detail::underlying_type_helper<BIT_WIDTH, false>::type unsigned_pod_type;
     ...
     */
    bool
    AssignFromStringShift(const char* str, const size_t n, const unsigned radix, const bool positive);
...
private:
    ...
    _CODASIP_INT_ENABLE_IF(
        _CODASIP_NATIVE_INT_BACKEND_COMPARE_CND(_CODASIP_RHS_BITS, _CODASIP_RHS_SIGN),
        bool)
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::NativeIntegerBackend() CODASIP_NOEXCEPT
  : m_Value(0)
{}
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::NativeIntegerBackend(
    const_reference rhs) CODASIP_NOEXCEPT : m_Value(rhs.m_Value)
{}

////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::NativeIntegerBackend(
    NativeIntegerBackend&& rhs) CODASIP_NOEXCEPT : m_Value(std::move(rhs.m_Value))
{}
...
_CODASIP_INT_INLINE
    NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator T() const CODASIP_NOEXCEPT
{
    return m_Value;
}
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE typename NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::reference
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator<<=(const unsigned rhs) CODASIP_NOEXCEPT
{
    if (rhs < BIT_WIDTH)
    {
...
template<typename T>
_CODASIP_INT_INLINE bool
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator==(const T& rhs) const CODASIP_NOEXCEPT
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE bool
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::IsNegative() const CODASIP_NOEXCEPT
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE bool
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::AssignFromString(const char* str, size_t n)
{
    bool isNeg = false;
    unsigned radix = 10;
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
inline std::string
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::ToStr(const std::ios_base::fmtflags flags) const
{
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE typename NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::pod_type*
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE const typename NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::pod_type*
...
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::swap(reference rhs) CODASIP_NOEXCEPT
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE void
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::AssignInteger(const pod_type rhs)
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE bool
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoAssignFromStringDec(const char* str,
    const bool isNeg)
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
inline bool
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::AssignFromStringShift(const char* str,
    const size_t n,
...
template<template<typename> class Comparator>
_CODASIP_INT_INLINE bool
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::Compare(const_reference rhs) const
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
template<template<typename> class Comparator, typename T>
_CODASIP_INT_INLINE _CODASIP_INT_ENABLE_IF_POD(T,
    bool) NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::Compare(const T rhs) const
{
...
template<template<typename> class Comparator, unsigned _CODASIP_RHS_BITS, bool _CODASIP_RHS_SIGN, typename T>
_CODASIP_INT_INLINE
_CODASIP_INT_ENABLE_IF(_CODASIP_NATIVE_INT_BACKEND_COMPARE_CND(_CODASIP_RHS_BITS, _CODASIP_RHS_SIGN),
    bool) NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoCompare(const T rhs) const
{
    using namespace ::codasip::integer::detail;
    typedef
        typename BinaryResultMaxPod<BIT_WIDTH, IS_SIGNED, _CODASIP_RHS_BITS, _CODASIP_RHS_SIGN>::type compare_type;
    // fast version comparing values directly
    return Comparator<compare_type>()(static_cast<compare_type>(m_Value),
...
{
    using namespace ::codasip::integer::detail;
    typedef return_type_helper<BIT_WIDTH, IS_SIGNED, _CODASIP_RHS_BITS, _CODASIP_RHS_SIGN> compare_type_helper;
    typedef NativeIntegerBackend<compare_type_helper::BINARY_W, compare_type_helper::BINARY_S> compare_type;
...
template<template<typename> class Operator>
_CODASIP_INT_INLINE void
NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DivMod(const_reference rhs)
{
...
template<template<typename> class Operator, typename T>
_CODASIP_INT_INLINE _CODASIP_INT_ENABLE_IF_POD(T,
    void) NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DivMod(const T rhs)
{
    DoDivMod<Operator,
        ::codasip::integer::detail::native_int_bitwidth_helper<T>::value,
        std::numeric_limits<T>::is_signed,
...
{
    typedef typename NativeIntegerBackend<_CODASIP_RHS_BITS, _CODASIP_RHS_SIGN>::pod_type rhs_pod_type;
    return DoDivMod<Operator, _CODASIP_RHS_BITS, _CODASIP_RHS_SIGN>(static_cast<rhs_pod_type>(rhs));
}
...
_CODASIP_INT_INLINE
_CODASIP_INT_ENABLE_IF(_CODASIP_NATIVE_INT_BACKEND_COMPARE_CND(_CODASIP_RHS_BITS, _CODASIP_RHS_SIGN),
    void) NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoDivMod(const T rhs)
{
    static_assert(_CODASIP_INT_INTEGRAL_CND(T),
        "This division function was defined for integral types only.");
    typedef typename ::codasip::integer::detail::
        BinaryResultMaxPod<BIT_WIDTH, IS_SIGNED, _CODASIP_RHS_BITS, _CODASIP_RHS_SIGN>::type result_type;
    ...
    void) NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoDivMod(const T rhs)
{
    static_assert(_CODASIP_INT_INTEGRAL_CND(T),
        "This division function was defined for integral types only.");
    typedef ::codasip::integer::detail::BinaryResultMaxPod<BIT_WIDTH, IS_SIGNED, _CODASIP_RHS_BITS, _CODASIP_RHS_SIGN>
        result_type_helper;
...
struct numeric_limits<::codasip::integer::backends::NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>>
  : public ::codasip::integer::detail::numeric_limits_base<
        ::codasip::integer::backends::NativeIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>>
{};
...
#endif   // COMMON_CODASIP_INTEGER_NATIVE_INTEGER_BACKEND_H_
