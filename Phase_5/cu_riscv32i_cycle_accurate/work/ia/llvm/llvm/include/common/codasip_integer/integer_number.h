...
#ifndef COMMON_CODASIP_INTEGER_INTEGER_NUMBER_H_
#define COMMON_CODASIP_INTEGER_INTEGER_NUMBER_H_

#include "common/codasip_integer/detail/misc.h"
#include "common/codasip_integer/detail/numeric_limits.h"
#include "common/codasip_integer/fixed_array_integer_backend.h"
#include "common/codasip_integer/native_integer_backend.h"
...
#    define _CODASIP_INTEGER_NUMBER_DEC_COMPOUND_PUBLIC(op) \
        template<class T>                                   \
        _CODASIP_INT_ENABLE_IF_POD(T, reference)            \
...
public:
    ...
    typedef typename std::conditional<IS_WRAPPER,
        ...
        backends::FixedArrayIntegerBackend<BIT_WIDTH, IS_SIGNED>>::type BackendType;
     ...
     *  \copydetails ToStrDec()
     */
    std::string get_oct(const bool showBase = false, const bool removeLeadingZeros = true) const;
    /**
    ...
    bool
    AssignFromStringShift(const std::string& str, const unsigned radix, const bool positive = true);
    /**
     * \}
     */
private:
    ...
    DoAssignDiv(const IntegerNumber<RHS_BITS, RHS_SIGNED>& value)
    {
        typedef typename codasip::integer::detail::
            BinaryOperatorHelper<codasip::integer::IntegerNumber, BIT_WIDTH, IS_SIGNED, RHS_BITS, RHS_SIGNED>::div_type
                result_type;
    ...
    {
        typedef typename codasip::integer::detail::
            BinaryOperatorHelper<codasip::integer::IntegerNumber, BIT_WIDTH, IS_SIGNED, RHS_BITS, RHS_SIGNED>::mod_type
                result_type;
        result_type tmp(*this);
        tmp.Backend() %= value.Backend();
        Backend() = tmp;
...
_CODASIP_INT_INLINE
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::IntegerNumber(const T rhs) CODASIP_NOEXCEPT
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::IntegerNumber(const char* str)
{
    this->operator=(str);
}
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::IntegerNumber(const std::string& str)
{
    this->operator=(str);
}
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::IntegerNumber(const_reference rhs) CODASIP_NOEXCEPT
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::IntegerNumber(IntegerNumber&& rhs) CODASIP_NOEXCEPT
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::IntegerNumber(
    std::initializer_list<pod_type> initList) CODASIP_NOEXCEPT : m_Backend(initList)
{}
...
_CODASIP_INT_INLINE typename std::enable_if<_CODASIP_INT_INTEGRAL_CND(T),
    typename IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::reference>::type
...
template<unsigned RHS_BITS, bool RHS_SIGNED>
_CODASIP_INT_INLINE typename IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::reference
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::operator/=(const IntegerNumber<RHS_BITS, RHS_SIGNED>& rhs)
{
...
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::swap(reference rhs) CODASIP_NOEXCEPT
{
...
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::get_bin(const bool showBase,
    const bool removeLeadingZeros,
    const unsigned bits) const
{
    DEBUG_CONDITION(BIT_WIDTH >= bits) << "Specified bit-width: " << bits
                                       << " has to be less or equal to: " << BIT_WIDTH << ::std::endl;
    const std::string value =
        Backend().ToStr(std::ios_base::dec ^ std::ios_base::dec).substr(BIT_WIDTH - bits);
    std::string result;
    if (showBase)
    {
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE std::string
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::get_oct(const bool showBase,
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE std::string
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::get_hex(const bool showBase,
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE std::string
IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>::ToStr(const std::ios_base::fmtflags flags) const
{
    return integer::detail::GetNumberPrefix(flags,
               Backend().IsNegative()) += integer::detail::RemoveLeadingZeros(Backend().ToStr(flags));
}
 ...
 */
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE std::ostream&
operator<<(std::ostream& os, const IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>& rhs)
{
 ...
 */
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE std::istream&
operator>>(std::istream& is, IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>& rhs)
{
    std::string str;
    is >> str;
...
struct numeric_limits<::codasip::integer::IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>>
  : public ::codasip::integer::detail::numeric_limits_base<
        ::codasip::integer::IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>>
{};

/**
 *  \class  std::make_signed
 *  \brief  Specialize std::make_signed for IntegerNumber.
 */
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
struct make_signed<::codasip::integer::IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>>
{
    typedef ::codasip::integer::IntegerNumber<_CODASIP_BITS, true> type;
};

/**
 *  \class  std::make_signed
 *  \brief  Specialize std::make_unsigned for IntegerNumber.
 */
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
struct make_unsigned<::codasip::integer::IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>>
{
    typedef ::codasip::integer::IntegerNumber<_CODASIP_BITS, false> type;
};

/**
 *  \brief  Specialize std::swap for IntegerNumber
 *  \param  lhs first operand
 *  \param  rhs second operand
 */
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE void swap(::codasip::integer::IntegerNumber<_CODASIP_BITS, _CODASIP_SIGN>& lhs,
...
#endif   // COMMON_CODASIP_INTEGER_INTEGER_NUMBER_H_
