...
public:
  ...
  // ==== CODASIP ====
  // Hack for LAU != 8, Fixup and Target does not hold always Section
  virtual unsigned getRelocType(MCContext &Ctx, const MCValue &Target,
                                const MCFixup &Fixup, bool IsPCRel,
                                const MCSectionELF &Section) const = 0;
  // =================
#if 0
  virtual unsigned getRelocType(MCContext &Ctx, const MCValue &Target,
  ...
  //============================== CODASIP =============================
  virtual void createRelocationExpressionTable(raw_ostream &OS) const {}
  //====================================================================
