...
private:
  ...
  SDValue buildUREMEqFold(EVT SETCCVT, SDValue REMNode, SDValue CompTargetNode,
                          ...
                          const SDLoc &DL) const;
// ======================= CODASIP =======================
// Hooks for special lowering of non-MVT types
protected:
  // Enabling (speed optimization to avoid a virtual call)
  bool SpecialTypeLower = false;
public:
  bool hasSpecialTypeLower() const {return SpecialTypeLower;}
  // A equivalent of getOperationAction
  virtual bool hasCustomLower(unsigned Op, EVT VT) const {return false;}
// =======================================================
};
