...
private:
  ...
  // =================== CODASIP ==============================================
  mutable llvm::SmallVector<VariableBitWidthIntType*, 32> VariableBitWidthIntTypes;
  // ==========================================================================
...
public:
  ...
  // ====================== CODASIP ===========================================
  QualType getVariableBitWidthIntType(unsigned Width, bool Signed, QualType T) const;
  // ==========================================================================
  /// Retrieve the C type declaration corresponding to the predefined
...
public:
  ...
  CanQualType getCanonicalType(QualType T) const {
    // =============== CODASIP ================================================
    // (don't comment this, it's required for propagation of VariableBitWidthIntType through typedefs)
    QualifierCollector Quals;
    const Type *Ptr = Quals.strip(T);
    QualType CanType = Ptr->getCanonicalTypeInternal();
    const VariableBitWidthIntType* VBWI = dyn_cast<const VariableBitWidthIntType>(Ptr);
    if (VBWI)
    {
      // is this all? try to check this out later...
