...
public:
  ...
  std::string DefaultTargetPrefix;
  /// Custom data layout.
  std::string CustomDataLayout;
  /// Clobber registers.
  std::string CustomClobbers;
  //============================================================
...
// =============== CODASIP ===============
#ifdef _WIN32
/// \return Demangled path on windows or input path otherwise
const char *demangleWinPath(const char *path);
#endif
// ======================================
