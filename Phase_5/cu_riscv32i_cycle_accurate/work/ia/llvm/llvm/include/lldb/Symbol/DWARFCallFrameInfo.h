...
private:
  ...
  /// ==== CODASIP ====
  static bool HandleCommonDwarfOpcode(const DataExtractor &DE,
                               uint8_t primary_opcode, uint8_t extended_opcode,
  ...
  lldb::RegisterKind GetRegisterKind() const {
    ///  ==== CODASIP ====
    // We assume that registers kind is always DWARF
    return lldb::eRegisterKindDWARF;
    /// =================
  }
};
