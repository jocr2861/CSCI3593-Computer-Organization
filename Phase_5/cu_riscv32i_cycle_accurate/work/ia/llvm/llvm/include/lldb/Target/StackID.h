...
public:
  ...
  /// ==== CODASIP ====
  // addr_t -> AddressBase
  explicit StackID(codasip::AddressBase pc, codasip::AddressBase cfa,
  /// =================
  ...
  /// ==== CODASIP ====
  // addr_t -> AddressBase
  codasip::AddressBase GetPC() const { return m_pc; }

  codasip::AddressBase GetCallFrameAddress() const { return m_cfa; }
  /// =================
...
protected:
  ...
  /// ==== CODASIP ====
  // addr_t -> AddressBase
  void SetPC(codasip::AddressBase pc) { m_pc = pc; }

  void SetCFA(codasip::AddressBase cfa) { m_cfa = cfa; }
  ...
  // library).
  codasip::AddressBase m_cfa; // The call frame address (stack pointer) value
