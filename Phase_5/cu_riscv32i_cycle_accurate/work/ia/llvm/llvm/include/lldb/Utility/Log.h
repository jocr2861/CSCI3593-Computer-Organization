...
public:
  ...
  void Printf(const char *format, ...) __attribute__((format(gnu_printf, 2, 3)));
  /// =================
  ...
  /// ==== CODASIP ====
  // format(printf) => format(gnu_printf)
  void Error(const char *fmt, ...) __attribute__((format(gnu_printf, 2, 3)));
  /// =================
  ...
  /// ==== CODASIP ====
  // format(printf) => format(gnu_printf)
  void Verbose(const char *fmt, ...) __attribute__((format(gnu_printf, 2, 3)));
  /// =================

  /// ==== CODASIP ====
  // format(printf) => format(gnu_printf)
  void Warning(const char *fmt, ...) __attribute__((format(gnu_printf, 2, 3)));
  /// =================
