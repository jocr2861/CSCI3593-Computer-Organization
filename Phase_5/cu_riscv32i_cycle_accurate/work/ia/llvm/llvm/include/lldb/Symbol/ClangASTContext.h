...
public:
  ...
  /// ==== CODASIP ====
  CompilerType
  GetVectorCompilerTypeForEncodingBitSizeAndVectSize(lldb::Encoding encoding,
                                             size_t bit_size,
                                             unsigned NumElts) override;

  CompilerType
  GetVectorCompilerTypeForEncodingBitSizeAndVectSize(clang::ASTContext *ast,
  ...
  /// ==== CODASIP ====
  ConstString GetLLVMTypeName(lldb::opaque_compiler_type_t type) override;
  /// =================
