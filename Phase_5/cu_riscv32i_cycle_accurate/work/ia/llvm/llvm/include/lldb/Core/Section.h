...
public:
  ...
  /// ==== CODASIP ====
  bool ResolveContainedAddress(const codasip::AddressBase &offset, Address &so_addr,
  ...
  /// ==== CODASIP ====
  /**
   * \brief Get address space name. "" for invalid addres sspace.
   */
  std::string GetAddressSpaceName() const;
  /**
   * \brief Return address space of this section
   */
  const codasip::AddressSpace& GetAddressSpace() const;
  /**
   * \brief Sets address space
   */
  void SetAddressSpace(const codasip::AddressSpace& address_space);
  /// =================
...
protected:
  ...
  /// ==== CODASIP ====
  codasip::AddressSpace m_address_space; // Address space class holding all important data
  /// =================
private:
