...
typedef std::shared_ptr<CodalContext> CodalContextSP;
typedef std::shared_ptr<PortContext> PortContextSP;
typedef std::shared_ptr<ResourceContext> ResourceContextSP;
typedef std::shared_ptr<SignalContext> SignalContextSP;
} // namespace codasip
/// =================
