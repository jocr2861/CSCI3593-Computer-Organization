...
public:
  ...
  /// ==== CODASIP ====
  codasip::PortContextSP GetPortContext();
  codasip::SignalContextSP GetSignalContext();
  codasip::CodalContextSP GetCodalContext();
  /// =================
...
private:
  ...
  /// ==== CODASIP ====
  codasip::PortContextSP m_port_context_sp;
  codasip::SignalContextSP m_signal_context_sp;
  codasip::CodalContextSP m_codal_context_sp;
  /// =================
  StackID m_id;
