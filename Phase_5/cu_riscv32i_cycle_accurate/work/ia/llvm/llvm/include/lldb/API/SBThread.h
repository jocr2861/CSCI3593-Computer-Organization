...
public:
  ...
  /// ==== CODASIP ====
  void StepOver(lldb::RunMode stop_other_threads, uint32_t step_count,
                const bool isStepInCodal, SBError &error);
  /// =================
  ...
  /// ==== CODASIP ====
  void StepInto(const char *target_name, uint32_t end_line, uint32_t step_count,
                const bool isStepInCodal, SBError &error,
                lldb::RunMode stop_other_threads = lldb::eOnlyDuringStepping);
  /// =================
  ...
  /// ==== CODASIP ====
  void StepOut(const bool isStepInCodal, SBError &error);
  /// =================
  ...
  /// ==== CODASIP ====
  void StepInstruction(bool step_over, uint32_t step_count,
                       const bool isStepInCodal, SBError &error);

  void StepCycle(uint32_t step_count, SBError &error);
  /// =================
