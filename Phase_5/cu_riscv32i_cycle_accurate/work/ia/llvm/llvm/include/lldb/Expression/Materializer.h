...
public:
  ...
  /// ==== CODASIP ====
  uint32_t AddResource(const codasip::Resource &resource, Status &err);
  uint32_t GetStructDwarf() { return m_struct_dwarf; }
  /// =================
  ...
  public:
    /// ==== CODASIP ====
    Entity() : m_alignment(1), m_size(0), m_offset(0), m_dwarf(0) {}
    uint32_t GetDwarf() { return m_dwarf; }
    /// =================
  ...
  protected:
    ...
    uint32_t m_offset;
    /// ==== CODASIP ====
    // DWARF of the used address space
    uint32_t m_dwarf;
    /// =================
  };
