...
public:
  ...
  /// ==== CODASIP ====
  lldb::SBValue GetPort(const uint32_t dwarf);
  /// \brief Uses register index instead of DWARF internally
  lldb::SBValue GetRegister(const uint32_t index);
  lldb::SBValue GetSignal(const uint32_t dwarf);
  /// =================
