...
public:
  ...
  static void AddValueToBuffer(
    lldb::DataBufferSP& buffer, const llvm::APInt& value, const lldb::ByteOrder processByteOrder);
  const llvm::APInt GetResourceValue() const;
  bool SetResourceValue(const llvm::APInt& value, const lldb::ByteOrder processByteOrder);
  lldb::SBWatchpoint Watch(bool resolve_location, bool read, bool write,
                           SBError &error);
  lldb::SBWatchpoint Watch(bool resolve_location, bool read, bool write,
                           lldb::SBData* data, SBError &error);
