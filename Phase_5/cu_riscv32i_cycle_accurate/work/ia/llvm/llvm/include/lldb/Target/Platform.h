...
public:
  ...
  /// ==== CODASIP ====
  virtual bool SetCodasipSimulatorPath(const FileSpec &sim_path) { return false; }
  /// =================
  ...
  virtual lldb::ProcessSP
  ConnectProcess(llvm::StringRef connect_url, llvm::StringRef plugin_name,
                 lldb_private::Debugger &debugger, lldb_private::Target *target,
                 lldb_private::Status &error,
                 /// ==== CODASIP ====
                 ProcessAttachInfo *attach_info = nullptr);
                 /// =================
