# 1 "/tools/toolchain/newlib-micro/libnxssys/open.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/tools/toolchain/newlib-micro/libnxssys/open.c" 2
...
# 2 "/tools/toolchain/newlib-micro/libnxssys/open.c" 2
...
# 4 "/tools/toolchain/newlib-micro/libnxssys/open.c" 2
