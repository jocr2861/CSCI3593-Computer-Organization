...
#ifndef COMMON_CODASIP_INTEGER_DETAIL_NUMERIC_LIMITS_H_
#define COMMON_CODASIP_INTEGER_DETAIL_NUMERIC_LIMITS_H_
...
public:
    ...
    {
        return is_signed ? (value_type(1) << (T::BIT_WIDTH - 1)) : value_type(0);
    }
    static value_type max() CODASIP_NOEXCEPT
    {
        return ~min();
    }
    static value_type lowest() CODASIP_NOEXCEPT
    {
        return min();
    }
    static value_type epsilon() CODASIP_NOEXCEPT
    {
        return value_type();
    }
    static value_type round_error() CODASIP_NOEXCEPT
    {
        return value_type();
    }
    ...
    static value_type infinity() CODASIP_NOEXCEPT
    {
        return value_type();
    }
    static value_type quiet_NaN() CODASIP_NOEXCEPT
    {
        return value_type();
    }
    static value_type signaling_NaN() CODASIP_NOEXCEPT
    {
        return value_type();
    }
    static value_type denorm_min() CODASIP_NOEXCEPT
    {
        return value_type();
    }
...
#endif   // COMMON_CODASIP_INTEGER_DETAIL_NUMERIC_LIMITS_H_
