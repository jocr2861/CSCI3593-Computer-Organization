...
/// ==== CODASIP ====
#include "lldb/Codasip/ArchDefinition.h"    // for AddressSpace
#include "lldb/Codasip/Utility.h"
/// =================
...
public:
  ...
  enum ContextType // Type that describes Value::m_context
  {
    ...
    /// ==== CODASIP ====
    ,eContextTypeResourceInfo     // Codasip ResourceInfo *
    /// =================
  };

/// ==== CODASIP ====
  const static size_t kMaxByteSize = CODASIP_INT_BYTE_SIZE;
/// =================
  ...
  struct Vector {
    ...
    Scalar GetAsScalar() const {
      ...
      if (IsValid()) {
        ...
        /// ==== CODASIP ====
          scalar = codasip::BytesToIntN(bytes, length, byte_order);
        /// =================
      }
      return scalar;
    }
  ...
  void SetAddressSpace(const codasip::AddressSpace& as);
  /// =================
  ...
  /// ==== CODASIP ====
  codasip::Resource *GetResource() const;
  /// =================
