...
public:
     ...
     */
    void AddBranch(const unsigned branchId, const std::string& file, const unsigned line);
...
public:
    ...
    typedef std::vector<std::string> EvaluationPatterns;
    typedef std::vector<uint64_t> EvaluationHits;
    typedef std::map<codasip_address_t, Counter> Combinations;

    CodalExpressionInfo();
    CodalExpressionInfo(std::string file,
        const unsigned line,
        const unsigned column,
        std::string content,
        Terms terms,
        EvaluationPatterns evaluations);

    /**
     * \brief Hit expression, with actual combination of term values.
     */
    void Hit(const uint64_t packedTerms);

    /**
     * \brief Getter
     */
    const Terms& GetTerms() const;
    const EvaluationPatterns& GetEvaluations() const;
    ...
    /**
     * \brief Returns a list of hits per evalution class (ie. not per term combinat)
     */
    EvaluationHits GetEvaluationHits() const;
...
private:
    ...
    Terms m_Terms;
    EvaluationPatterns m_Evaluations;
    // terms 101 -> index 9
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline const CodalExpressionInfo::EvaluationPatterns& CodalExpressionInfo::GetEvaluations() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline BlockAddress::BlockAddress(const codasip_address_t address, const Flag flag, const std::string& name)
  : m_Address(address)
  , m_Flag(flag)
  , m_Name(name)
{}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
inline void DecodedSequences<T>::SetSequenceLengths(const SequenceLengths& sequenceLengths)
{
    for (SequenceLengths::const_iterator it = sequenceLengths.begin(); it != sequenceLengths.end(); ++it)
    {
...
inline void DecodedSequences<T>::Hit(const T& value)
{
    ...
    for (SequenceLengths::const_iterator it = m_SequenceLengths.begin(); it != m_SequenceLengths.end();
         ++it)
    {
        size_t length = *it;
 ...
 */
template<class T>
class Decoder : public DecoderBase, public DecodedInstructions<T>, public DecodedSequences<T>
{
public:
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
inline Decoder<T>::Decoder(const std::string& id, const std::string& signature, const unsigned int bitWidth)
...
{
    // get hit in raw format
    const typename DecodedSequences<T>::Sequences& sequencesImpl = DecodedSequences<T>::GetSequences();
    // converted stats
...
/// key => address
/// val => hits count
typedef std::unordered_map<DumpTypes::Address, DumpTypes::Counter> AddressHits;
...
public:
     ...
     */
    codasip_address_t GetAddress() const;
    const AddressHits& GetHits() const;
    const Counter& GetCycleHits() const;
    ...
    void Hit(const codasip_address_t endAddress);
    void CycleHit();
...
private:
    /// address
    codasip_address_t m_Address;
    /// number of accesses by the end address
    AddressHits m_Hits;
    /// number of cycles spend on given address
    Counter m_CycleHits;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline const AddressHits& Sample::GetHits() const
{
    return m_Hits;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline const Counter& Sample::GetCycleHits() const
{
    return m_CycleHits;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline void Sample::SetAddress(const codasip_address_t address)
{
    m_Address = address;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline void Sample::Hit(const codasip_address_t endAddress)
{
    m_Hits[endAddress]++;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline void Sample::CycleHit()
{
    m_CycleHits++;
}
...
inline void Sample::DecoderHit(const int decoderId, const TInt value)
{
    ...
    Decoder<TInt>* decoder = static_cast<Decoder<TInt>*>(&(*itDecoder->second));
...
{
public:
    typedef std::vector<std::pair<Counter, codasip_address_t>> Snapshots;
...
{
    return m_Snapshots.size() >= 1000000;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline void CallStack::Clear()
{
    return m_Snapshots.clear();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline CallStack::Snapshots& CallStack::GetSnapshots()
{
    return m_Snapshots;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline const CallStack::Snapshots& CallStack::GetSnapshots() const
{
    return m_Snapshots;
}
