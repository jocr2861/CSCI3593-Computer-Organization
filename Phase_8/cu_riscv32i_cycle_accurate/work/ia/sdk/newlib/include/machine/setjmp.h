...
// Codasip
#include "setjmp-buf.h"

#ifndef SETJMP_BUF
#error "Implementation of setjmp buffer was not provided. Implement <model>/libs/newlib/libc/include/machine/setjmp-buf.h."
#else
typedef SETJMP_BUF
#undef SETJMP_BUF
#endif
...
//==================== CODASIP =====================
// jmp_buf is defined in the model
#if 0
//==================================================
#ifdef __riscv
