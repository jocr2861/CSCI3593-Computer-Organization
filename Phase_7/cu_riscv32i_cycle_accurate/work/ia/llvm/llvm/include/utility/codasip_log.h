...
#ifndef UTILITY_CODASIP_LOG_H_
#define UTILITY_CODASIP_LOG_H_
...
LOG_INFO(const unsigned verbosity = LOG_DEFAULT_VERBOSITY, const std::string& str = "");
/**
 ...
 */
logging::LoggingMessage
LOG_WARNING(const WarningType type = WARN_GENERAL, const std::string& str = "");
/**
 ...
 */
logging::LoggingMessage
LOG_WARNING(const Location& loc, const WarningType type = WARN_GENERAL, const std::string& str = "");
/**
 ...
 */
logging::LoggingMessage
LOG_ERROR(const std::string& file, const unsigned line, const std::string& str = "");
/**
 *  \copydoc LOG_ERROR()
 *  \param loc source file and line number
 */
logging::LoggingMessage LOG_ERROR(const Location& loc, const std::string& str = "");
/**
