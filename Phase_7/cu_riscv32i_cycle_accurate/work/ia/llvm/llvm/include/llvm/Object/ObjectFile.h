...
protected:
  ...
  // ================= CODASIP =================
  virtual bool useDefaultAS(DataRefImpl Sec) const;
  // ===========================================
...
// ================== CODASIP ==================
inline bool SectionRef::useDefaultAS() const {
  return OwningObject->useDefaultAS(SectionPimpl);
}
// =============================================
