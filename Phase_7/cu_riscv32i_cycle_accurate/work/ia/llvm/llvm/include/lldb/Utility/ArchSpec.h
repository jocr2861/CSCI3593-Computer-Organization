...
public:
  ...
  /// ==== CODASIP ====
  enum CodasipSubType {
    eCodasipSubType_unknown,
    eCodasipSubType_codasip_be,
    eCodasipSubType_codasip_le
  };
  enum RiscvSubType {
  ...
  enum Core {
    ...
    /// ==== CODASIP ====
    kCore_riscv_first = eCore_riscv32,
    kCore_riscv_last = eCore_riscv64,

    kCore_codasip_first = eCore_codasip_le,
    kCore_codasip_last = eCore_codasip_be
    /// =================
  ...
  /// ==== CODASIP ====
  /**
   * \brief Return true, if the Arch spec or Core is Codasip processor
   */
  bool IsCodasip() const;
  bool IsRiscV() const;
  /// =================
