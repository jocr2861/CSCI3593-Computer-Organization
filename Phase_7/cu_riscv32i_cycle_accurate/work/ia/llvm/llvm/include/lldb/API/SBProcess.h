...
public:
  ...
  /// ==== CODASIP ====
  lldb::SBError Reset();
  lldb::SBError GetCycleCount(uint64_t& cc);
  lldb::SBDynamicRegisterInfo GetDynamicRegisterInfo();

  lldb::SBError DumpProfiler();
  /// =================
  ...
  /// ==== CODASIP ====
  size_t ReadMemory(const codasip::AddressBase& addr, void *buf, size_t size, lldb::SBError &error);
  /// =================

  size_t ReadMemory(addr_t addr, void *buf, size_t size, lldb::SBError &error);

  /// ==== CODASIP ====
  size_t WriteMemory(const codasip::AddressBase& addr, const void *buf, size_t size,
                     lldb::SBError &error);
  /// =================
