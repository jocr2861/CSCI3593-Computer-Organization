...
#ifndef COMMON_CODASIP_INTEGER_FIXED_ARRAY_BACKEND_BACKEND_IMPL_H_
#define COMMON_CODASIP_INTEGER_FIXED_ARRAY_BACKEND_BACKEND_IMPL_H_

#include "common/codasip_integer/fixed_array_backend/arithmetic.h"
#include "common/codasip_integer/fixed_array_backend/assign.h"
...
#include "common/codasip_integer/fixed_array_backend/division.h"
#include "common/codasip_integer/fixed_array_integer_backend.h"
...
#    define _CODASIP_FIXED_ARRAY_INT_BACKEND_DEF_COMPOUND(op, func)                                 \
        ...
        template<class T>                                                                           \
        _CODASIP_INT_INLINE typename std::enable_if<_CODASIP_INT_INTEGRAL_CND(T),                   \
            typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::reference>::type \
...
#    define _CODASIP_FIXED_ARRAY_INT_BACKEND_DEF_COMPARISON(op, func)                                            \
        ...
        _CODASIP_INT_INLINE _CODASIP_INT_ENABLE_IF_POD(T, bool)                                                  \
            FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator op(const T rhs)               \
                const                                                                                            \
        {                                                                                                        \
            typedef integer::detail::return_type_helper<BIT_WIDTH,                                               \
                IS_SIGNED,                                                                                       \
                integer::detail::native_int_bitwidth_helper<T>::value,                                           \
                std::is_signed<T>::value>                                                                        \
                result_type;                                                                                     \
            typedef FixedArrayIntegerBackend<result_type::BIT_WIDTH, result_type::IS_SIGNED> cmp_type;           \
                                                                                                                 \
        ...
        _CODASIP_INT_INLINE bool FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator op(      \
        ...
        {                                                                                                        \
            typedef integer::detail::return_type_helper<BIT_WIDTH, IS_SIGNED, RHS_BITS, RHS_SIGNED> result_type; \
            typedef FixedArrayIntegerBackend<result_type::BIT_WIDTH, result_type::IS_SIGNED> cmp_type;           \
                                                                                                                 \
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
template<unsigned RHS_BITS, bool RHS_SIGNED>
_CODASIP_INT_INLINE typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::reference
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::reference
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator=(const_reference rhs) CODASIP_NOEXCEPT
{
    if (this != &rhs)
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::reference
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::operator=(value_type&& rhs) CODASIP_NOEXCEPT
{
    if (this != &rhs)
    {   // avoid self assignment
        CopyValue(rhs.data());
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::value_type
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE bool
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::IsNegative() const CODASIP_NOEXCEPT
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE bool
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::AssignFromString(const char* str, size_t n)
{
    bool isNeg = false;
    unsigned radix = 10;
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::pod_type*
...
////////////////////////////////////////////////////////////////////////////////
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE const typename FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::pod_type*
...
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::swap(reference rhs) CODASIP_NOEXCEPT
{
 ...
 */
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE void FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::InitZero()
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE void
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::CopyValue(const pod_type* value)
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE void
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoBitCorrection()
{
    if (REMINDER_LEFT != 0)
    {
        m_Value[SIZE - 1] = static_cast<pod_type>(
            static_cast<pod_type>(m_Value[SIZE - 1] << REMINDER_LEFT) >> REMINDER_LEFT);
    }
}
...
_CODASIP_INT_INLINE _CODASIP_INT_ENABLE_IF_POD(T,
    void) FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoBitwiseCompound(const T rhs)
{
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
inline bool
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::AssignFromStringShift(const char* str,
    const size_t n,
    ...
    const bool)
{
    ...
    for (size_t ii = 0, jj = 0; (ii < SIZE) && (jj < n); ++ii, jj += digitsPerWord)
    {
        ...
        const size_t count = (jj + digitsPerWord) > n ? (n - jj) : digitsPerWord;
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
inline bool
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoAssignFromStringOct(const char* str,
    size_t /*n*/)
{
    ...
    enum : unsigned
    {
        DEGITS_PER_BLOCK = std::numeric_limits<block_type>::digits / 3
    };
    enum : block_type
    {
        BASE = 8
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
inline bool
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoAssignFromStringDec(const char* str,
    size_t n)
{
    typedef uint64_t block_type;
    ...
    enum
    {
        DEGITS_PER_BLOCK = std::numeric_limits<block_type>::digits10
    };
    enum : block_type
    {
        BASE = 10
...
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::ToStrDec() const
{
    ...
    static const pod_type div = static_cast<pod_type>(
        std::pow(base, std::numeric_limits<pod_type>::digits10));
    ...
    {   // eliminate the number of vector divisions
        ...
        detail::DoDivModUnsigned<SIZE, 1, pod_type>(rem.m_Value, quo.m_Value, copy.m_Value, &div);
...
template<unsigned _CODASIP_BITS, bool _CODASIP_SIGN>
_CODASIP_INT_INLINE std::string
FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::ToStrHex(const char val) const
{
    std::string result;
    result.reserve(BIT_WIDTH / 4);
    result = integer::detail::ToHexadecimalStr<REMINDER_RIGHT, pod_type>(m_Value[SIZE - 1], val);
    for (unsigned ii = SIZE - 1; ii != 0; --ii)
    {
        result += integer::detail::ToHexadecimalStr<UNDERLYING_BIT_WIDTH, pod_type>(m_Value[ii - 1],
            val);
    }
    return result;
}
...
_CODASIP_INT_INLINE _CODASIP_INT_ENABLE_IF_POD(T,
    void) FixedArrayIntegerBackend<_CODASIP_BITS, _CODASIP_SIGN, true>::DoDivModCompound(const T rhs)
{
    DoDivModCompound<DIVMOD>(
        FixedArrayIntegerBackend<integer::detail::native_int_bitwidth_helper<T>::value,
    ...
    const FixedArrayIntegerBackend<RHS_BITS, RHS_SIGN>& rhs)
{
    ...
    typedef integer::detail::return_type_helper<BIT_WIDTH, IS_SIGNED, RHS_BITS, RHS_SIGN> res_helper;
    typedef FixedArrayIntegerBackend<res_helper::BINARY_W, false> res_type;
...
#endif   // COMMON_CODASIP_INTEGER_FIXED_ARRAY_BACKEND_BACKEND_IMPL_H_
