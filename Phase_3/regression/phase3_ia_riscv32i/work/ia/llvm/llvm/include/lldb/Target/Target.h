...
public:
  ...
  /// ==== CODASIP ====
  bool GetSimulatorArguments(Args &args) const;

  void SetSimulatorArguments(const Args &args);
  /// =================
...
private:
  ...
  /// ==== CODASIP ====
  static void SimulatorArgsValueChangedCallback(void *target_property_ptr,
                                                   OptionValue *);
  /// =================
...
public:
  ...
  lldb::BreakpointSP CreateBreakpoint(lldb::addr_t load_addr, bool internal,
                                      bool request_hardware, const uint32_t dwarf = -1);
  ...
  lldb::WatchpointSP CreateWatchpoint(lldb::addr_t addr, size_t size,
                                      ...
                                      Status &error);
  // Enables common index pool for stoppoints (break/watch)
  long GetNextStoppointIndex();
  /// =================
