...
private:
  ...
  /// ==== CODASIP ====
public:
  virtual bool IsStepInCodal() const { return m_StepInCodal; }
  void SetStepInCodal(const bool value) { m_StepInCodal = value; };
private:
  bool m_StepInCodal = false;
  /// =================
