...
protected:
  // ==== CODASIP ====
  explicit MCExpr(ExprKind Kind, SMLoc Loc) : Kind(Kind), Loc(Loc), AttributeId("") {}
  // =================
#if 0
...
public:
  ...
  // ==== CODASIP ====
  const std::string& getAttributeId() const { return AttributeId; };
  void setAttributeId(const std::string& Value) const { AttributeId = Value; };
  /// Determines whether expression has AND operation with mask.
  bool hasMask() const;
  /// Attribute identifier
  mutable std::string AttributeId;
  // =================
...
class MCConstantExpr : public MCExpr {
  ...
  // ==== CODASIP ====
  /// Could hide truncation warning when set on true
  bool IsMasked = false;
  // =================
...
public:
  ...
  static const MCConstantExpr *create(int64_t Value, MCContext &Ctx,
                                      bool PrintInHex = false);
  // ==== CODASIP ====
  static const MCConstantExpr *createCodasip(int64_t Value, MCContext &Ctx, const bool IsMasked);
