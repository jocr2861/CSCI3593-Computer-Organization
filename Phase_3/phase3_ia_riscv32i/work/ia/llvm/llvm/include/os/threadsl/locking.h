...
#ifndef OS_THREADSL_LOCKING_H_
#define OS_THREADSL_LOCKING_H_

#include "os/compiler.h"   // HANDLE
...
public:
    ...
    void Wait(ReentrantMutex& mutex);
    /**
 ...
 * \param  timeout Optional timeout in milliseconds. If negative function will wait infinitely,
 ...
 */
wait_return_t WaitOnHandle(const HANDLE handle, const bool read, const int timeout = -1);
