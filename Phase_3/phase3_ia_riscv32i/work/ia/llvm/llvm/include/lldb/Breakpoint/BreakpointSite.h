...
public:
  ...
  bool IntersectsRange(const codasip::AddressBase& addr, size_t size,
                       codasip::AddressBase *intersect_addr, size_t *intersect_size,
...
private:
  ...
  BreakpointSite(BreakpointSiteList *list,
                 ...
                 // ==== CODASIP ====
                 const codasip::AddressBase& m_addr,
                 // =================
                 bool use_hardware);
